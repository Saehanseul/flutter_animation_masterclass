        ...
        body: Stack(
          children: [
            AnimatedSwitcher(
              ...
              child: Container(
                key: ValueKey(_currentPage), // 키가 바뀌어야 새로운 위젯으로 인식해서 애니메이션을 줌
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage("assets/covers/${_currentPage + 1}.jpeg"),
                    fit: BoxFit.cover,
                  ),
                ),
                  ...
                  children: [
                    ValueListenableBuilder(
                      ...
                      builder: (context, scroll, child) {
                        ...
                        // print(
                        //     "We are $difference cards away from card ${index + 1}");
